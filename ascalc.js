...
var eh6 = Number($('#eh6').val()); //ダブルＡＳ付与効果値
var eh7 = Number($('#eh7').val()); //ＡＳ特殊変化効果値
var eh8 = Number($('#eh8').val()); //ダメージ強化パネル効果値
var exmp = Number($('#exmp').val()); //EXAS効果値
var ch = Number($('#ch').val()); //チェイン数
var ehtotal = eh1 + eh2 + eh3 + eh4 + eh5 + eh6 + eh7+ eh8; //ダメージ強化合計
